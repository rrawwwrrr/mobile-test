...
echo "║                                                          ║"
echo "║  2. Скопируй APK (если нет интернета):                   ║"
echo "║     cp ApiDemos-debug.apk /var/lib/adbtest/apk/          ║"
echo "║                                                          ║"
echo "║  3. Запусти сервис:                                      ║"
echo "║     systemctl start adbtest                              ║"
echo "║                                                          ║"
echo "║  4. Логи:  journalctl -u adbtest -f                      ║"
echo "║  5. Дашборд: http://<ip>:9080                            ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
EOF
